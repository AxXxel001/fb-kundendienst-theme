...
<!--  Last Published: Wed Jun 21 2017 16:28:42 GMT+0000 (UTC)  -->
<html data-wf-page="59483698c804bd3ccbf52133" data-wf-site="59482d29f464447de1847323">
<head>
  <meta charset="utf-8">
  ...
  <link href="css/fb-kundendienst-theme.webflow.css" rel="stylesheet" type="text/css">
...
<body class="body">
  <div class="navbar w-nav" data-animation="default" data-collapse="medium" data-duration="400">
    <div class="navbar-container w-container">
      <a class="navbar-brand w-nav-brand" href="#"><img sizes="(max-width: 479px) 85vw, (max-width: 767px) 86vw, (max-width: 991px) 668px, 483.4375px" src="images/logo_full.png" srcset="images/logo_full-p-500.png 500w, images/logo_full-p-800.png 800w, images/logo_full-p-1080.png 1080w, images/logo_full.png 1500w">
      </a>
      <nav class="navbar-menu w-nav-menu" role="navigation"><a class="navbar-navlink w-nav-link" href="#">Home</a><a class="navbar-navlink w-nav-link" href="with-sidebar.html">with-sidebar</a><a class="navbar-navlink w-nav-link" href="blogpost.html">blogpost</a><a class="navbar-navlink w-nav-link" href="single.html">single</a>
      </nav>
    ...
    <div class="content-sidebarcontainer w-container">
      <div class="left-content-wrapper">
          ...
          <div class="blogpost-wrapper">
            <div class="fb-post-wrapper"><img class="fb-post-image" src="https://d3e54v103j8qbb.cloudfront.net/img/image-placeholder.svg" width="64">
              <div class="fb-post-data-wrapper">
                ...
                <div class="fb-post-data-time-wrapper">
                  <div class="light-grey">Gestern</div><img class="fb-post-data-time-icon" src="https://d3e54v103j8qbb.cloudfront.net/img/image-placeholder.svg" width="15">
                </div>
              </div>
            </div>
        ...
        <div class="fb-post-full-wrapper">
          ...
          <div class="blogpost-wrapper">
            <div class="fb-post-wrapper"><img class="fb-post-image" src="https://d3e54v103j8qbb.cloudfront.net/img/image-placeholder.svg" width="64">
              <div class="fb-post-data-wrapper">
                <div class="fb-post-data-name-wrapper">
                  <div class="fb-blue">Vorname</div>
                  <div class="blur fb-blue">Nachname</div><img class="fb-post-data-name-icon" src="https://d3e54v103j8qbb.cloudfront.net/img/image-placeholder.svg" width="15">
                  <div class="fb-blue">Unternehmen</div>
                </div>
                <div class="fb-post-data-time-wrapper">
                  <div class="light-grey">Gestern</div><img class="fb-post-data-time-icon" src="https://d3e54v103j8qbb.cloudfront.net/img/image-placeholder.svg" width="15">
        ...
        <div class="pagination-wrapper">
          <div class="pagination-button-wrapper"><a class="button button-square w-button" href="#">1</a>
          </div>
          <div class="pagination-button-wrapper"><a class="button button-square w-button" href="#">2</a>
          </div>
          <div class="pagination-button-wrapper"><a class="bg-white button button-square w-button" href="#">...</a>
          </div>
          <div class="pagination-button-wrapper"><a class="button button-square w-button" href="#">20</a>
          </div>
        </div>
      </div>
